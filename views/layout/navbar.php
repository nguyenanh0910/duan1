		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav text-nowrap">
				...
				<li class="nav-item dropdown megamenu-li"> <a class="nav-link"
						href="<?= BASE_URL . '?act=danh-sach-san-pham' ?>">
						Sản phẩm </a> </li>
				<?php if (isset($_SESSION['user'])): ?>
					<li class="nav-item dropdown megamenu-li">
						<a class="nav-link" href="<?=BASE_URL . '?act=form-edit-thong-tin-ca-nhan-khach-hang'?>">Xin chào <?= $_SESSION['user']['ho_ten'] ?></a>
					</li>
					<li class="nav-item dropdown megamenu-li"><a class="nav-link" href="<?=BASE_URL . '?act=logout-client'?>" onclick="return confirm('Đăng xuất tài khoản?')">Đăng xuất</a></li>
				<?php else: ?>
					<li class="nav-item dropdown megamenu-li">
			...
			<div class="rate-price nav-1">
				...
				<ul>
				<?php if (isset($_SESSION['user'])): ?>
					<li class="dropdown"> <a href="<?=BASE_URL . '?act=form-edit-thong-tin-ca-nhan-khach-hang'?>"> <i class="fa fa-user-circle-o"></i></a>
					</li>
					<li><a href="wishlist.html"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
					<li class="dropdown"> <a href="<?=BASE_URL . '?act=gio-hang'?>"><i	class="fa fa-shopping-bag" aria-hidden="true"></i></a>
					<?php else: ?>
						...
						<div class="dropdown-menu dropdown-menu-right animate slideIn"> 
							...
							<a class="dropdown-item" href="forgot-password.html">Quên mật khẩu</a> </div>
					</li>
					<li><a href="wishlist.html"><i class="fa fa-heart-o" aria-hidden="true"></i></a></li>
					<li class="dropdown"> <a class="dropdown-toggle link" href="#" data-bs-toggle="dropdown"><i	class="fa fa-shopping-bag" aria-hidden="true"></i></a>
						<?php endif; ?>
					</li>
				</ul>
			</div>
	...
	<div class="row align-items-center">
		...
		<div class="col-lg-12 col-md-8">
			<div class="input-group filter-by">
				...
				<input type="text" class="form-control border" name="x" placeholder="Bạn cần tìm gì?">
				<span class="input-group-btn">
					<button class="btn btn-default search-bt" type="button">Tìm Kiếm</button>
				</span>
			</div>
		</div>
	</div>
