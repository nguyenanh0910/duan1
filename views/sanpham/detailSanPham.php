										...
										<div class="input-group">
											...
											<span class="input-group-btn">
												<button type="button" class="btn btn-default btn-number" data-type="plus"
													data-field="quant[1]"><i class="fa fa-plus"></i> </button>
											</span>
										</div>
									</div>
									<div class="col-md-6 col-sm-6"> <a class="btn add-to-cart2" id="add-to-cart" href="#">Thêm vào giỏ
											hàng</a>
									</div>
								</div>
							</div>
				...
				<div id="tabs" class="description">
					<div>
						...
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active text-1" id="nav-home" role="tabpanel"
									...
									<div class="col-md-6">
										<div class="row m-0 text-center-m">
											...
											<?php foreach ($listBinhLuan as $index => $binhLuan): ?>
												<div class="col-lg-2 col-md-3 col-sm-2 text-center mb-3"><img
